function(adaptagrams_add_library)
    ...
    set(multiValueArgs SOURCES HEADERS PUBLIC_INCLUDE_DIRS PUBLIC_DEFINITIONS PRIVATE_DEFINITIONS PUBLIC_COMPILE_OPTIONS PUBLIC_LINK_OPTIONS PUBLIC_LINK_LIBS)
    ...
    if(ALIB_PRIVATE_DEFINITIONS)
        target_compile_definitions(${_obj} PRIVATE ${ALIB_PRIVATE_DEFINITIONS})
    endif()
    ...
    foreach(_kind STATIC SHARED)
        if((${_kind} STREQUAL "STATIC" AND BUILD_STATIC_LIBS) OR
           (${_kind} STREQUAL "SHARED" AND BUILD_SHARED_LIBS))
            ...
            if(ALIB_PRIVATE_DEFINITIONS)
                target_compile_definitions(${_variant} PRIVATE ${ALIB_PRIVATE_DEFINITIONS})
            endif()
            if(ALIB_PUBLIC_COMPILE_OPTIONS)
